...
from shortlist.edgar.index import fetch_amendment_records
from shortlist.edgar.stake_pct import stake_pct_from_filing
...
def test_fetch_amendment_records_filters_to_amendments(monkeypatch):
    ...
    monkeypatch.setattr("shortlist.edgar.index._get_13d_index_rows",
...
def test_fetch_amendment_records_never_raises(monkeypatch):
    ...
    monkeypatch.setattr("shortlist.edgar.index._get_13d_index_rows", boom)
    import warnings
