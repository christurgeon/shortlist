...
def _bot(**kw):
    cfg = {"bot": {"max_screen": 2, "max_deep": 1, "deep_screen_sources": ["mock"]}}
...
def _deep_bot(max_deep, **fns):
    ...
    cfg = {"bot": {"max_screen": 10, "max_deep": max_deep, "deep_screen_sources": ["mock"]}}
...
def test_help_mentions_explain():
    from shortlist.bot.telegram import _HELP
