...
"""
from shortlist.bot.models import SignalStatus, run_health
...
def _vm_ok(name, discovery=True):
    from shortlist.bot.report.viewmodel import SignalStatusVM
...
def test_report_names_the_failed_originators_on_a_degraded_run():
    ...
    from shortlist.bot.report.sections import Detail, _Footer
