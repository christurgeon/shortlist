...
A dependency-light leaf consumed by the harness WsbSource (async, via to_thread).
One bulk GET of the wallstreetbets filter (page 1 = top tickers by volume),
normalized + disk-cached by fetch date. NEVER raises.
"""
