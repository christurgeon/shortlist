"""Report-side run model. `Emission` lives in `edgar/models.py` — it is the EDGAR clients'
return type and is re-exported here only for the consumers that still name it."""
from __future__ import annotations

from dataclasses import dataclass, field
from datetime import date

from ..edgar.models import Emission  # noqa: F401 — re-exported
